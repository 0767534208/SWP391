      ...
      <aside className="manager-sidebar-fixed bg-indigo-900 text-white shadow-lg">
        ...
        <nav className="manager-nav py-2">
          <div className="manager-nav-container px-2 space-y-1">
            <Link to="/manager" className={`manager-nav-link flex items-center px-2 py-1.5 rounded-lg transition-colors ${isActive('/manager') && !isActive('/manager/services') && !isActive('/manager/blogs') && !isActive('/manager/slots') ? 'bg-indigo-800 text-white' : 'text-indigo-100 hover:bg-indigo-800'}`}>
