      ...
      <aside className="consultant-sidebar-fixed bg-indigo-900 text-white shadow-lg">
        ...
        <nav className="consultant-nav py-2">
          <div className="consultant-nav-container px-2 space-y-1">
            ...
            <Link to="/consultant/slot-registration" className={`consultant-nav-link flex items-center px-2 py-1.5 rounded-lg transition-colors ${isActive('/consultant/slot-registration') ? 'bg-indigo-800 text-white' : 'text-indigo-100 hover:bg-indigo-800'}`}>
              <svg xmlns="http://www.w3.org/2000/svg" className="consultant-sidebar-icon" viewBox="0 0 20 20" fill="currentColor">
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clipRule="evenodd" />
              </svg>
              <span className="consultant-nav-text text-xs font-medium">Đăng ký khung giờ</span>
            </Link>
            
            <a href="/qna" className={`consultant-nav-link flex items-center px-2 py-1.5 rounded-lg transition-colors text-indigo-100 hover:bg-indigo-800`}>
              <svg xmlns="http://www.w3.org/2000/svg" className="consultant-sidebar-icon" viewBox="0 0 20 20" fill="currentColor">
                <path fillRule="evenodd" d="M18 10c0 3.866-3.582 7-8 7a8.841 8.841 0 01-4.083-.98L2 17l1.338-3.123C2.493 12.767 2 11.434 2 10c0-3.866 3.582-7 8-7s8 3.134 8 7zM7 9H5v2h2V9zm8 0h-2v2h2V9zM9 9h2v2H9V9z" clipRule="evenodd" />
              </svg>
              <span className="consultant-nav-text text-xs font-medium">Hỏi & Đáp</span>
            </a>
          </div>
        </nav>
